...
def init_sample_data():
    ...
    with app.app_context():
        ...
        race1_entries = [
            RaceResult(race_id=race1.id,
                       horse_id=horses[0].id, jockey_id=jockeys[0].id, place=1),
            RaceResult(race_id=race1.id,
                       horse_id=horses[1].id, jockey_id=jockeys[1].id, place=2),
            RaceResult(race_id=race1.id,
                       horse_id=horses[2].id, jockey_id=jockeys[2].id, place=3),
            RaceResult(race_id=race1.id,
                       horse_id=horses[3].id, jockey_id=jockeys[3].id, place=4),
        ]
        ...
        race2_entries = [
            RaceResult(race_id=race2.id,
                       horse_id=horses[4].id, jockey_id=jockeys[4].id, place=1),
            RaceResult(race_id=race2.id,
                       horse_id=horses[5].id, jockey_id=jockeys[5].id, place=2),
            RaceResult(race_id=race2.id,
                       horse_id=horses[6].id, jockey_id=jockeys[0].id, place=3),
            RaceResult(race_id=race2.id,
                       horse_id=horses[7].id, jockey_id=jockeys[1].id, place=4),
        ]
        ...
        race3_entries = [
            RaceResult(race_id=race3.id,
                       horse_id=horses[0].id, jockey_id=jockeys[2].id, place=1),
            RaceResult(race_id=race3.id,
                       horse_id=horses[3].id, jockey_id=jockeys[4].id, place=2),
            RaceResult(race_id=race3.id,
                       horse_id=horses[5].id, jockey_id=jockeys[1].id, place=3),
        ]
